...
var eventsController = require('cloud/controllers/events.js');
...
var basicAuth = express.basicAuth('test','test');

// The information showed about the poster
var userEmail = 'godefroy.lemerdy@gmail.com';
var userDisplayName = 'Godefroy';
var userDescription = 'Shable developper';
...
app.get('/planifier', postsController.new);
app.get('/recherche', postsController.index2);
app.get('/profil', postsController.profil);
app.get('/event', postsController.activity);
