...
var Post = Parse.Object.extend('Events2');

// Display all sport posts.
...
exports.create = function(req, res) {
  ...
  post.save(_.pick(req.body, 'type', 'activity', 'visibility', 'title', 'date', 'period', 'place')).then(function() {
    res.redirect('/posts');
  },
  function() {
    res.send(500, 'Failed saving activity');
  });
};
